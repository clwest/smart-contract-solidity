...
def get_contract(contract_name):
    """This function will grab the contract addressed from teh brownie config if defined
        otherwise, it will deploy a mock version of that contract, and retrun that mock code
            Args:
